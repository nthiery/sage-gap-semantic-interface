...
setup(
    ...
    py_modules=['mygap','categories.objects'],
    install_requires=['recursive-monkey-patch','sage-semantic-annotations==dev"], # 'Sage'
    dependency_links=['http://github.com/nthiery/sage-semantic-annotations/tarball/master#egg=dev'],
